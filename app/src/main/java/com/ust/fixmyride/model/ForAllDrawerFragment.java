 ...
 */
public class ForAllDrawerFragment extends DialogFragment{
    ...
    public void onStart() {
        ...
        if (d!=null){
            ...
            getDialog().getWindow()
                    .getAttributes().windowAnimations = R.style.dialog_animation_fade;
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        bounce=(RelativeLayout)root.findViewById(R.id.bounce);
